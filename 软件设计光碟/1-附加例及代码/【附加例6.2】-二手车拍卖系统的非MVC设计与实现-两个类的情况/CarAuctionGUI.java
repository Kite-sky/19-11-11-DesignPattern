...
public class CarAuctionGUI extends JPanel{
  ...
  private void setUpButtonPanel(){
	 ...
	 String[] cl = af.extractCarList();
     af.setUpCarList(cmbCarList,cl);
     ...
     public void actionPerformed(ActionEvent e){
        ...
        if (e.getActionCommand().equals(CarAuctionGUI.SEARCH)){
           String selectedCar = getSelectedCar();
  		   ...
  		   ImageIcon imgIcon = af.produceCarImaIcon(selectedCar);
  		   URL url = af.constructCarFileUrl(selectedCar);

           af.updateCarPicture(imgLabel,imgIcon);
           af.updateCarDescription(editorPane, url);
        }
        if (e.getActionCommand().equals(CarAuctionGUI.BIT)){
           ...
           af.showBitPrice(bitShownText, prc);
  	  }
     }
