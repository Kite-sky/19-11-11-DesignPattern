...
public class GrayOutFilter extends Filter {
   ...
   public GrayOutFilter(Pipe input, Pipe output, JLabel imLabel,BufferedImage originalImg){
      super(input, output);
      this.input = input;
      this.output= output;
   ...
   public int filterRGB(int rgb) {
   		...
   		int pixValue = (redPix << 16) | (greenPix << 8) | bluePix;
   		return pixValue;
	}
}
